...
uacpi_status uacpi_initialize(uacpi_u64 flags)
{
    ...
    serial_printf("uacpi_initialize - init_level now is %d\n", g_uacpi_rt_ctx.init_level);
...
uacpi_status uacpi_namespace_load(void)
{
    ...
    serial_printf("uacpi_namespace_load - init_level now is %d\n", g_uacpi_rt_ctx.init_level);
    serial_line("");
    return UACPI_STATUS_OK;
...
uacpi_status uacpi_namespace_initialize(void)
{
    ...
    serial_printf("uacpi_namespace_initialize - init_level now is %d\n", g_uacpi_rt_ctx.init_level);
#ifdef UACPI_KERNEL_INITIALIZATION
